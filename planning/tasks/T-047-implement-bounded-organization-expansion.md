...
- Syntax handoff, eligibility, pagination, capacity, ordering, truncation, deduplication, cancellation, errors, and empty results match the closed RG-010/RG-009 contracts.
